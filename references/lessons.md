...
- **作者行**:头像 32 大圆角方形(radius-md 12;体系统一形状,见 DESIGN.md 头像 Avatar 节);昵称+官方绿标(五瓣星形 accent/base + surface/base 对勾);@handle·时间 muted;隐私锁图标;Follow 胶囊 = surface/secondary 底 + default/foreground 14 Semibold
