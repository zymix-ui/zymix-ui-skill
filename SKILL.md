...
- 圆角用 `var(--radius-*)`,不写硬值
- 分割线 0.5px `var(--separator-base)`;强分割 1px `var(--separator-strong)`
...
```
```html
<i class="zi" style="--zi:url(https://cdn.jsdelivr.net/gh/zymix-ui/zymix-icons@v1.2.0/svgs/rocket.svg)"></i>
```
base URL:`https://cdn.jsdelivr.net/gh/zymix-ui/zymix-icons@v1.2.0/svgs/<name>.svg`(`.zi` 已在 components.css)。⚠CDN 图标需联网,预览卡片不显示、真机/浏览器正常。全部图标名见图标仓库 svgs/。
